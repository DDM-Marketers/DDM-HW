...
profit = margin * (sum(valid_df[valid_df$value > 0, ]$value) / n_cust * 1000000) - 1000000 * cost
#2388385 per 1 million customer
...
```{r}
valid_df$predicted_targeting_profit = valid_df$value 
...
```{r}
#No, we will lose a lot of ranking data
```
