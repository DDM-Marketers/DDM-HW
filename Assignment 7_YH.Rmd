...
```{r}
validation_df = validation_df %>%
   mutate(predicted_targeting_profit = cut_number(exp_profit, n = 20, labels = FALSE))
...
**The targeting profits increases as targeting percent increases from 1%, and reaches its peak when targeting percent is between 31%-34%, then gradually declines. **
...
**The optimal targeting percentage is from 31% to 34%, the corresponding targeting profit is $2,764,201. **
...
**$325,622 more profits can be earned when targeting the top 31%-34% of customers compared to targeting none of the customers. That represents a 13.35% increase in profits from the baseline profit without targeting.**
